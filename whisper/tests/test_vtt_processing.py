...
from services.vtt_processing import timestamp_to_ms
...
class TestSaveVttLines:
    ...
    @patch("services.vtt_processing.bulk_insert_vtt_lines")
    @patch("services.vtt_processing.get_series_of_vtt_file")
    @patch("services.vtt_processing.get_vtt_file_by_id")
    def test_parses_vtt_and_inserts_lines(
        self, mock_get_vtt, mock_get_series, mock_bulk_insert
    ):
        from models import VttFile, SeriesData
